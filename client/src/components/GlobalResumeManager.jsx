        ...
        <div className="p-8">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-3xl font-bold text-gray-800 font-display">Global Resume Manager</h2>
            </div>
            <button
              onClick={onClose}
              className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-all duration-200 text-xl font-bold"
            >
              ×
            </button>
          </div>
          ...
          <div className="mb-8">
            <label className="block font-semibold text-gray-700 mb-3 text-lg">Resume Content</label>
            <textarea
              value={resumeText}
              onChange={(e) => setResumeText(e.target.value)}
              placeholder="Paste your resume here..."
              className="w-full border border-gray-300 rounded-lg px-6 py-4 h-96 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-sans text-base leading-relaxed"
            />
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={onClose}
              className="px-8 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-all duration-200 font-semibold"
            >
              Cancel
            </button>
          </div>
